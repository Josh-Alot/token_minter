// ABI completo do contrato BurnoutToken
export const BURNOUT_TOKEN_ABI = [
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "to", type: "address" },
      { indexed: false, internalType: "uint256", name: "amount", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newBalanceFrom", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newBalanceTo", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "timestamp", type: "uint256" },
    ],
    name: "TokensTranferred",
    type: "event",
  },
  {
    anonymous: false,
...
// Endereço do contrato - será configurado após deploy
// Para desenvolvimento local, use o endereço do contrato deployado
export const BURNOUT_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_TOKEN_ADDRESS as `0x${string}` | undefined;

// ABI do contrato BurnoutNFTFactory
export const BURNOUT_NFT_FACTORY_ABI = [
  {
    anonymous: false,
    inputs: [
      {
